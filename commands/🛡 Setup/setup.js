            ...
            message.guild.channels.create(`🎧｜Music`, {
                ...
                message.guild.channels.create(`🎵｜Requests`, {
                    ...
                    let pehla = new MessageEmbed()
                        ...
                        .setTitle("DNA  Music | Request | Guide")
                        .setDescription(`Enter the song name or URL to play a song\n\n For Example ${config.prefix}play \`Love The Way You Lie Lofi  \``)
                    ...
                    let dusra = new MessageEmbed()
                        ...
                        .setThumbnail(client.user.displayAvatarURL())
                        .setAuthor(message.author.username)
                        .setTitle("DNA Music - Bot Made By DNA")
                        .setDescription(`Join a voice channel and enter a song name or url to play.\n[Invite DNA Music](https://discord.com/api/oauth2/authorize?client_id=892644039550173195&permissions=8&scope=bot) • [Join Server](https://discord.gg/RBcw6WygqE) • [Subscribe Now](https://youtube.com/channel/UCUTx4CyDYDTEKHy1CNduCyg)`)
